# Telegram Serverless Deployment Guide for ShipienBot

This guide explains how to deploy **ShipienBot** directly onto Telegram's native **Serverless Platform** (`tgcloud`).
...
2. Send command `/mybots` and select your bot (`@shipienbot`).
